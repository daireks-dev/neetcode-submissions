class Solution:
    def minWindow(self, s: str, t: str) -> str:
        ...
        #Useful because it accounts for the edge case of no valid answer
        ...
        for R in range(0, len(s)):
            ...
            #Whenever a unique character from t is added to the window:
            if char in stringCount and windowCount[char] == stringCount[char]:
                have += 1
            
            #How far can we reduce this substring until its invalid?
            while have == need:
